...
cl /c /O2 /MD /W3 -DWIN_NT -DBIT64 latlong_lens.cpp latlong_lens_dll.cpp "C:\Program Files\NVIDIA Corporation\mentalray 3.14 for Maya 2017\devkit\shaders\shader.c"
