...
cd C:\Users\Andrew\Documents\GitHub\domemaster-stereo-shader\mentalray\original\domeAFL_2017\sources\

ECHO. Started compiling the mental ray shader
cl /c /O2 /MD /W3 -DWIN_NT -DBIT64 domeAFL_FOV_Stereo.c domeAFL_FOV.c domeAFL_WxH.c test_texture.c "C:\Program Files\Autodesk\mentalrayForMaya2016Beta7\devkit\shaders\shader.c"
