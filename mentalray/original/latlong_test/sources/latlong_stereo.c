...
//mi_info("II-> fovV=%f,fovH=%f,cam=%i,rad=%f,tilt=%f,sep=%f,comp=%i,vert=%i",fov_vert_angle,fov_horiz_angle,camera,dome_radius,dome_tilt,cameras_separation,dome_tilt_compensation,vertical_mode);
