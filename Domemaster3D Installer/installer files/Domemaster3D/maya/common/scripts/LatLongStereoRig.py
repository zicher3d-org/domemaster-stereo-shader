"""
LatLong_Stereo Camera Rig V2.4
2018-08-21
...
def createLensShaders(centerCam, leftCam, rightCam):
  ...
  if(mayaVersion <= 2015):
    ...
    latlong_maya_placement = cmds.shadingNode('place2dTexture', n='latlong_place2dTexture', asUtility=True) 
    ...
    for tex in [separation_map_maya_tex]:
      cmds.connectAttr(latlong_maya_placement+'.coverage', tex+'.coverage', f=True)
      cmds.connectAttr(latlong_maya_placement+'.translateFrame', tex+'.translateFrame', f=True)
      cmds.connectAttr(latlong_maya_placement+'.rotateFrame', tex+'.rotateFrame', f=True)
      cmds.connectAttr(latlong_maya_placement+'.mirrorU', tex+'.mirrorU', f=True)
      cmds.connectAttr(latlong_maya_placement+'.mirrorV', tex+'.mirrorV', f=True)
      cmds.connectAttr(latlong_maya_placement+'.stagger', tex+'.stagger', f=True)
      cmds.connectAttr(latlong_maya_placement+'.wrapU', tex+'.wrapU', f=True)
      cmds.connectAttr(latlong_maya_placement+'.wrapV', tex+'.wrapV', f=True)
      cmds.connectAttr(latlong_maya_placement+'.repeatUV', tex+'.repeatUV', f=True)
      cmds.connectAttr(latlong_maya_placement+'.offset', tex+'.offset', f=True)
      cmds.connectAttr(latlong_maya_placement+'.rotateUV', tex+'.rotateUV', f=True)
      cmds.connectAttr(latlong_maya_placement+'.noiseUV', tex+'.noiseUV', f=True)
      cmds.connectAttr(latlong_maya_placement+'.vertexUvOne', tex+'.vertexUvOne', f=True)
      cmds.connectAttr(latlong_maya_placement+'.vertexUvTwo', tex+'.vertexUvTwo', f=True)
      cmds.connectAttr(latlong_maya_placement+'.vertexUvThree', tex+'.vertexUvThree', f=True)
      cmds.connectAttr(latlong_maya_placement+'.vertexCameraOne', tex+'.vertexCameraOne', f=True)
      #cmds.connectAttr(latlong_maya_placement+'.outUV', tex+'.uvCoord', f=True)
      cmds.connectAttr(latlong_maya_placement+'.outUvFilterSize', tex+'.uvFilterSize', f=True)

      # Hook the mental ray texture vector node to the file node's UV coordinates inputs
      cmds.connectAttr(latlong_tex_vector+'.outValueX', tex+'.uCoord', f=True)
      cmds.connectAttr(latlong_tex_vector+'.outValueY', tex+'.vCoord', f=True)
