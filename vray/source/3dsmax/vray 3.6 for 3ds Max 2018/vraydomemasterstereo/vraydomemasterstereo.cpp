/**********************************************************************
  ...
  vray DomemasterStereo Shader v0.9
  2018-06-21
...
class VRayCamera: public GenCamera, public VR::VRayCamera2 {
  IParamMap2 *pmap;
  static Mesh mesh;
...
public:
  ...
  Object* ConvertToType(TimeValue t, Class_ID obtype) { vassert(0); return NULL; }
